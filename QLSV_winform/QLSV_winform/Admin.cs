...
namespace QLSV_winform
{
    public partial class Admin : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                string sql = "SELECT tk AS [Tên Tài Khoản], mk AS [Mật Khẩu] FROM [admin]";
        ...
        private void btn_them_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlInsert = "INSERT INTO [admin] (tk, mk) VALUES (@tentk, @mk)";
        ...
        private void btn_sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlUpdate = "UPDATE [admin] SET mk = @mk WHERE tk = @tentk";
        ...
        private void btn_xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlDelete = "DELETE FROM [admin] WHERE tk = @tentk";
